...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function getTAXCODE(element, ID) {
            $('#ctl00$ContentPlaceHolder1$txtDTAXCODE').val(ID);
            popupTAXCODE.Hide();
        }
                ...
                <div class="tab-pane fade in" id="POLine">
                    <asp:UpdatePanel ID="upPOLInes" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <%--                            <table class="table table-striped table-bordered table-hover" cellspacing="0" rules="all" border="1" id="a" style="width:100%;border-collapse:collapse;">
                                <tr>
                                    <th scope="col" style="width: 1%">&nbsp;</th>
                                    <th scope="col" style="width: 5%">Line No</th>
                                    <th scope="col" style="width: 10%">
                                        <input id="ContentPlaceHolder1_grd_chkCC" type="checkbox" name="a" /><span>&nbspCost Code</span>
                                    </th>
                                    <th scope="col" style="width: 10%">

                                        <span>&nbspLine Type</span>
                                    </th>
                                    <th scope="col" style="width: 40%">

                                        <span>&nbspDescription</span>
                                    </th>
                                    <th scope="col" style="width: 8%">

                                        <span>&nbspQuantity</span>
                                    </th>
                                    <th scope="col" style="width: 8%">
                            ...
                            <asp:GridView ID="grd" AutoGenerateSelectButton="false" SelectedRowStyle-Font-Bold="true" SelectedRowStyle-BackColor="Silver" DataKeyNames="POLINEID" runat="server" CssClass="table table-striped table-bordered table-hover;overflow:scroll;" AutoGenerateColumns="False" OnRowCreated="grd_RowCreated" OnRowUpdating="grd_RowUpdating" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="grd_RowEditing" OnRowCommand="grd_RowCommand" Width="100%" Height="100px" PageSize="5" OnPageIndexChanging="grd_PageIndexChanging" AllowPaging="false">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Line No" ItemStyle-Width="5%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPONum" runat="server" Text='<%#Eval("POLINENUM")  %>' />
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <%--<asp:Label ID="lblPONumEdit" runat="server" Text='<%#Eval("POLINENUM")  %>' />--%>
                                            <asp:TextBox ID="txtPOLineNumEdit" runat="server" Text='<%#Eval("POLINENUM")  %>' onkeyup="return SetCCValue(this.value, 'txtDPOLineNum', this);" AutoPostBack="true" OnTextChanged="txtPOLineNumEdit_TextChanged"></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                            ...
                                            <div class="reg-panel panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    <div class="form-horizontal">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                                                <span class="showAstrik">*</span>Line Price:</label>
                                                            <div class="col-sm-7">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-3 Pdringtop" for="inputName">TAX Code:</label>
                                                            <div class="col-sm-6">
                                                                <asp:TextBox ID="txtDTAXCODE" runat="server" CssClass="form-control" ValidationGroup="Equip" OnTextChanged="txtDTAXCODE_TextChanged" AutoPostBack="true" Enabled="false"></asp:TextBox>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-3 Pdringtop" for="inputName">TAX :</label>
                                                            <div class="col-sm-6">
                                                                <asp:TextBox ID="txtDTotalTax" runat="server" CssClass="form-control" ValidationGroup="Equip" Text="" Enabled="false"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-3 Pdringtop" for="inputName">TAX Exempt?</label>
                                                            <div class="col-sm-6">
                                                                <asp:CheckBox runat="server" ID="chkDTAXExempt" Text="" OnCheckedChanged="chkDTAXExempt_CheckChanged" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="panel-body">
                                                    <div class="form-horizontal">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <asp:TextBox ID="txtQuantityReceived" runat="server" CssClass="form-control" ValidationGroup="Equip"></asp:TextBox>
                                                            </div>
                                                            <div style="width: 2%; float: left;">
                                                            </div>
                                                        </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <span>
                                    <asp:Button ID="Button3" runat="server" CssClass="btn btn-default" Text="Refresf" CausesValidation="false" OnClick="btnRefreshPOLines_Click" />
                                </span>
                                <span>
                        ...
                        <div class="form-horizontal">
                            <div class="form-group" style="margin: 10px;">
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <div style="margin-left: -15px !important; margin-bottom: 5px;">
                                            <asp:Button ID="btnSelectSignature" runat="server" CssClass="btn btn-default" Text="Select Signature" OnClientClick="isDirty1 = true;" OnClick="btnSelectSignature_Click" />
                                        </div>
                                        <br />
                                        <div class="form-group">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Organization">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:HiddenField ID="lblPOpSecurityPOSignID" runat="server" Value='<%#Eval("POSignID") %>'></asp:HiddenField>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Heading">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPopupSecuritHeading" runat="server" Text='<%#Eval("Heading") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Title">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPopupSecuritTitle" runat="server" Text='<%#Eval("Title") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Emp Code">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPopupSecuritTeamMemberCode" runat="server" Text='<%#Eval("TeamMemberCode") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Emp Name">
                                                            <ItemTemplate>
