    ...
    public partial class frmUpdatePurchaseOrder : System.Web.UI.Page
    {
        ...
        protected void MaxLength()
        {
            ...
            { 
                ...
                txtDItem.Attributes.Add("maxlength", MaxREMARK.ToString());
        ...
        void CalculateTotalCost(DataTable dt)
        {
            ...
            txtPOLinesPurchaseOrderTotalCost.Text = (res + tax).ToString();

            //res = (from o in dt.AsEnumerable() where o.Field<string>("ActionTaken") != "Delete" select Convert.ToDecimal(o.Field<string>("TAXTOTAL"))).ToList().Sum();

            txtPretaxTotal.Text = tax.ToString();
            upPoDetail.Update();
        ...
        void calculateValues(DataRow dr)
        {
            ...
            try
            {
                ...
                txtPretaxTotal.Text = "10";
                txtTotalCost.Text = "100000";
            }
            catch (Exception ex) { }
        }
                ...
                if (UsrPOSignature != null)
                {
                    try
                    {
                        ...
                        if (ddlEditSignatureUser.Text != "")
                        {
                            ...
                            empName = SplitName[1];
                            EmpCode = ddlEditSignatureUser.SelectedItem.Value.ToString();
                        }
        ...
        protected void lnkSignatureEditOptin_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (POSignature != null)
            {
                ...
                upSignaturePanel.Update();
                ModalSignature.Show();
                ddlEditSignatureUser.DataSource = db.FIRMS_GetAllEmployee().Where(x => x.emp_desig_code == POSignature.Designation);// && x.emp_visa_org == int.Parse(HIDOrganizationCode.Value);
        ...
        public void LoadPoppSignatureUser()
        {
            try
            {
                ddlEditSignatureUser.DataSource = db.FIRMS_GetAllEmployee();
                ddlEditSignatureUser.DataBind(); 
            }
            catch (Exception ex)
            {
