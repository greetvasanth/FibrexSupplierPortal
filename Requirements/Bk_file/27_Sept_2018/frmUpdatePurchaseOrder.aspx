                            ...
                            <asp:GridView ID="grd" AutoGenerateSelectButton="false" SelectedRowStyle-Font-Bold="true" SelectedRowStyle-BackColor="Silver" DataKeyNames="POLINEID" runat="server" CssClass="table table-striped table-bordered table-hover;overflow:scroll;" AutoGenerateColumns="False" OnRowCreated="grd_RowCreated" OnRowUpdating="grd_RowUpdating" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="grd_RowEditing" OnRowCommand="grd_RowCommand" Width="100%" PageSize="5" OnPageIndexChanging="grd_PageIndexChanging" AllowPaging="false" OnRowDataBound="grd_RowDataBound">
                                <Columns>
                                        ...
                                        <EditItemTemplate>
                                            <div class="form-group">
                                                <div class="col-sm-10" style="margin-right: 0px;">
                                                    <asp:TextBox ID="txtPOEditItem" runat="server" CssClass="form-control" onkeyup="return SetCCValue(this.value, 'txtDItemCode', this);" Text='<%#Eval("ITEMNUM") %>' onfocus="this.select();"></asp:TextBox>
                                                </div>
                                    ...
                                    <asp:TemplateField HeaderText="Description" ItemStyle-Width="30%">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtgvDescriptionEdit" runat="server" CssClass="form-control" onkeyup="return SetCCValue(this.value, 'txtDItem', this);" Rows="15" Height="50px" TextMode="MultiLine" Text='<%#Eval("Description") %>' OnTextChanged="txtgvPOLineDescriptionEdit_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtgvDescriptionNew" runat="server" CssClass="form-control" onkeyup="return SetCCValue(this.value, 'txtDItem', this);" Rows="15" Height="50px" TextMode="MultiLine" Text='<%#Eval("Description") %>' OnTextChanged="txtgvPOLineDescriptionEdit_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                                ...
                                                <div class="col-sm-6" style="margin-left: 10px;">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-sm-2" for="inputName">
                                                            Cost Code:</label>
                                                        <div class="col-sm-3">
                                                            <asp:TextBox ID="txtDCostCode" runat="server" CssClass="form-control" ValidationGroup="Equip" OnTextChanged="txtDCostCode_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                        </div>
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-sm-4 pdright" for="inputName">
                                                            Supplier Ref.</label>
                                                        <div class="col-sm-7">
                                                            <asp:TextBox ID="txtDCatalogCode" runat="server" CssClass="form-control" ValidationGroup="Equip" OnTextChanged="txtDCatalogCode_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-sm-4 pdright" for="inputName">
                                                    ...
                                                    <div class="form-horizontal">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <asp:TextBox ID="txtDDTAXCODE" runat="server" CssClass="form-control" OnTextChanged="txtDTAXCODE_TextChanged" AutoPostBack="true"></asp:TextBox>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:GridView ID="gvPoSignature" runat="server" CssClass="table table-striped table-bordered table-hover" EmptyDataText="No search results" AutoGenerateColumns="False" DataKeyNames="POSignID" OnPageIndexChanging="gvPoSignature_PageIndexChanging" OnRowDataBound="gvPoSignature_RowDataBound">
                                            <Columns>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <div class="form-horizontal" id="divEditSignature" runat="server" visible="false">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <dx:ASPxComboBox ID="ddlEditLoadDesignation" runat="server" ValueField="dgt_desig_code" TextField="dgt_desig_name" ValueType="System.String" CssClass="form-control" EnableCallbackMode="true" IncrementalFilteringMode="Contains" OnSelectedIndexChanged="ddlEditLoadDesignation_SelectedIndexChanged" AutoPostBack="true">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <dx:ASPxComboBox ID="ddlEditSignatureUser" runat="server" ValueField="emp_Code" TextField="Name" ValueType="System.String" CssClass="form-control" EnableCallbackMode="true" IncrementalFilteringMode="Contains">
                                                            <Columns>
                                            ...
                                            <asp:GridView ID="gvPopUpPOSignature" runat="server" CssClass="table table-striped table-bordered table-hover" EmptyDataText="No search results" AutoGenerateColumns="false" OnPageIndexChanging="gvPopUpPOSignature_PageIndexChanging" AllowPaging="true" PageSize="10" AllowSorting="true">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Title">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblPopupSecuritTitle" runat="server" Text='<%#Eval("dgt_desig_name") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                                <PagerSettings Mode="NumericFirstLast" />
                                            ...
                                            <asp:SqlDataSource runat="server" ID="DSLoadAllPOSignature" ConnectionString='<%$ ConnectionStrings:CS %>' SelectCommand="SELECT * FROM [POSignatureTemplates]"></asp:SqlDataSource>
