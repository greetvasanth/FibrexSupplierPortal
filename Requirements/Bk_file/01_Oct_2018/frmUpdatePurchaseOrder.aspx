            ...
            <div class="tab-content">
                            ...
                            <asp:GridView ID="grd" AutoGenerateSelectButton="false" SelectedRowStyle-Font-Bold="true" SelectedRowStyle-BackColor="Silver" DataKeyNames="POLINEID" runat="server" CssClass="table table-striped table-bordered table-hover;overflow:scroll;" AutoGenerateColumns="False" OnRowCreated="grd_RowCreated" OnRowUpdating="grd_RowUpdating" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="grd_RowEditing" OnRowCommand="grd_RowCommand" Width="100%" PageSize="5" OnPageIndexChanging="grd_PageIndexChanging" AllowPaging="false" OnRowDataBound="grd_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Line Type" ItemStyle-Width="9%">
                                        ...
                                        <EditItemTemplate>
                                            <asp:DropDownList ID="ddlLineTypeEdit" runat="server" DataSourceID="DSgvPurchaseType" AutoPostBack="true" CssClass="form-control" DataValueField="Value" DataTextField="Description" OnTextChanged="ddlLineTypeEdit_TextChanged"></asp:DropDownList> <%--DataSourceID="DSgvPurchaseType" --%>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                        ...
                                        <EditItemTemplate>
                                            <div class="form-group">
                                                <div class="col-sm-10" style="margin-right: 0px;">
                                                    <asp:TextBox ID="txtPOEditItem" runat="server" CssClass="form-control"  Text='<%#Eval("ITEMNUM") %>' onfocus="this.select();" ReadOnly="true"></asp:TextBox>
                                                </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="col-sm-6" style="margin-left: 10px;">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <asp:TextBox ID="txtDPOLineNum" runat="server" CssClass="form-control" ValidationGroup="Equip" OnTextChanged="txtDPOLineNum_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <asp:TextBox ID="txtDItemCode" runat="server" CssClass="form-control" ValidationGroup="Equip" ReadOnly="true" AutoPostBack="true"></asp:TextBox>
                                                        </div>
                                                        <div style="float: left; margin-left: -12px" class="col-sm-1">
                ...
                <div class="tab-pane fade in" id="POSignature">
                    ...
                    <div class="form-horizontal">
                        ...
                        <asp:Panel ID="PanelSignature" runat="server" class="ResetPanel" Style="display: none; width: 35%;">
                            <div style="width: 25px; height: 25px; position: absolute; margin-left: 96%; margin-top: 7px; cursor: pointer;">
