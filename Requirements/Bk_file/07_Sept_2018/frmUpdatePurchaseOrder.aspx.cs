    ...
    public partial class frmUpdatePurchaseOrder : System.Web.UI.Page
    {
        ...
        protected void grd_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("Insert"))
            {
                ...
                dtCurrentTable.Rows[dtCurrentTable.Rows.Count - 1]["TotalPrice"] = (Convert.ToDecimal(txtGvPrice.Text) * Convert.ToDecimal(txtGvQuantity.Text)).ToString("#,##0.0000");
                dtCurrentTable.Rows[dtCurrentTable.Rows.Count - 1]["POLINEID"] = (res * res) * (-1);

                if (txtGvQuantity.Text != "")
                {
                    dtCurrentTable.Rows[dtCurrentTable.Rows.Count - 1]["Quantity"] = Convert.ToDecimal(txtGvQuantity.Text).ToString("#,##0.0000");// Quantity;
                }
                else
                {
                ...
                if (txtGvPrice.Text != "")
                {
                    dtCurrentTable.Rows[dtCurrentTable.Rows.Count - 1]["UnitPrice"] = Convert.ToDecimal(txtGvPrice.Text).ToString("#,##0.0000");  //UnitPrice;
                }
                else
                {
                ...
                if (txtGvPrice.Text != "")
                {
                    dtCurrentTable.Rows[dtCurrentTable.Rows.Count - 1]["TotalPrice"] = Convert.ToDecimal(dtCurrentTable.Rows[dtCurrentTable.Rows.Count - 1]["TotalPrice"]).ToString("#,##0.0000"); ; //TotalPrice.ToString("N4");
                }
                else
                {
        ...
        protected void grd_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            TextBox txtgvtxtPOCostCode = (TextBox)row.FindControl("txtPOCostCode1");
            DropDownList ddlLineType = (DropDownList)row.FindControl("ddlLineType1");
            TextBox txtgvCATALOGCODE = (TextBox)row.FindControl("txtgvCATALOGCODE1");
            TextBox txtgvDescription = (TextBox)row.FindControl("txtgvDescription1");
            TextBox txtGvQuantity = (TextBox)row.FindControl("txtPOQtn1");
            TextBox txtUnite = (TextBox)row.FindControl("txtPOUnit1");
            TextBox txtGvPrice = (TextBox)row.FindControl("txtPOUnitPrice1");
            TextBox txtGvTotalPrice = (TextBox)row.FindControl("txtPOUnitTotal1");
            ...
            if (rowID != null)
            {
                ...
                else
                {
                    ...
                    dr["TotalPrice"] = (Convert.ToDecimal(txtGvPrice.Text) * Convert.ToDecimal(txtGvQuantity.Text)).ToString("#,##0.0000");
                    dr["ActionTaken"] = "Update";
                    if (txtGvQuantity.Text != "")
                    {
                        dr["Quantity"] = Convert.ToDecimal(txtGvQuantity.Text).ToString("#,##0.0000");// Quantity;
                    }
                    else
                    {
                    ...
                    if (txtGvPrice.Text != "")
                    {
                        dr["UnitPrice"] = Convert.ToDecimal(txtGvPrice.Text).ToString("#,##0.0000");  //UnitPrice;
                    }
                    else
                    {
                    ...
                    if (txtGvPrice.Text != "")
                    {
                        dr["TotalPrice"] = Convert.ToDecimal(dtCurrentTable.Rows[dtCurrentTable.Rows.Count - 1]["TotalPrice"]).ToString("#,##0.0000"); ; //TotalPrice.ToString("N4");
                    }
                    else
                    {
                        //dtCurrentTable.Rows[dtCurrentTable.Rows.Count - 1]["TotalPrice"] = dtCurrentTable.Rows[dtCurrentTable.Rows.Count - 1]["TotalPrice"];//
                      ...
                      /*  if (ObjgetPo.POREF != null)
                       ...
                       // }
                        ...
                        if (ObjgetPo.TOTALCOST != null)
                        {
                            ...
                            txtTotalCost.Text = Convert.ToDecimal(ObjgetPo.TOTALCOST).ToString("#,##0.0000");
                        }
                        if (ObjgetPo.TOTALTAX != null)
                        {
                            txtPOLinesPurchaseOrderTotalCost.Text = Convert.ToDecimal(ObjgetPo.TOTALCOST).ToString("#,##0.0000");
                            txtPOTotalTax.Text = Convert.ToDecimal(ObjgetPo.TOTALCOST).ToString("#,##0.0000");
                        }
                        ...
                        LoadAllPoLines(ObjgetPo.PONUM, ObjgetPo.POREVISION);
        ...
        private void LoadAllPoLines(decimal PoNum, short Revision)
        {
            try
            {
                ResetLabel();
