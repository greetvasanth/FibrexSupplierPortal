                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <asp:TextBox ID="txtPretaxTotal" runat="server" CssClass="form-control" ValidationGroup="Equip"></asp:TextBox> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-5 Pdringtop" for="inputName">
                                            ...
                                            <div class="col-sm-6">
                                                <asp:TextBox ID="txtPOTotalTax" runat="server" CssClass="form-control" ValidationGroup="Equip"></asp:TextBox> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-5 Pdringtop" for="inputName">
                                            ...
                                            <div class="col-sm-6">
                                                <asp:TextBox ID="txtTotalCost" runat="server" CssClass="form-control" ValidationGroup="Equip"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-5 Pdringtop" for="inputName">
                                            ...
                                            <div class="col-sm-6">
                                                <asp:TextBox ID="txtPOCurrency" runat="server" CssClass="form-control" ValidationGroup="Equip" Text="AED"></asp:TextBox></div>
                                        </div>
                                        </fieldset>
                                    </div>
                                </div>
                        ...
                        <ContentTemplate>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Cost Code" ItemStyle-Width="9%">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="txtPOCostCode" runat="server" CssClass="form-control" onkeypress="return SetPolineFlag();" OnTextChanged="txtPOCostCode_TextChanged" AutoPostBack="true" Text='<%#Eval("CostCode") %>' onfocus="this.select();"></asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="Line Type" ItemStyle-Width="8%">
                                        ...
                                        <ItemTemplate>
                                            <asp:DropDownList ID="ddlLineType" runat="server" CssClass="form-control" onkeypress="return SetPolineFlag();" DataSourceID="DSgvPurchaseType" DataValueField="Value" DataTextField="Description" OnTextChanged="ddlLineType_TextChanged" AutoPostBack="true"></asp:DropDownList>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Supplier Ref" ItemStyle-Width="9%">
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtgvCATALOGCODE" runat="server" CssClass="form-control" onkeypress="return SetPolineFlag();" onfocus="this.select();" Text='<%#Eval("CATALOGCODE") %>' OnTextChanged="txtgvCATALOGCODE_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Quantity" ItemStyle-Width="7%">
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtPOQtn" runat="server" CssClass="form-control" onkeyup="javascript:this.value=Comma(this.value);" onkeypress="return SetPolineFlag();" onfocus="this.select();" Text='<%#Eval("Quantity") %>' OnTextChanged="txtPOQtn_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="UOM" ItemStyle-Width="10%">
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtPOUnit" runat="server" CssClass="form-control" onkeypress="return SetPolineFlag();" onfocus="this.select();" Text='<%#Eval("Unit") %>' OnTextChanged="txtPOUnit_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Unit Price" ItemStyle-Width="10%">
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtPOUnitPrice" runat="server" onfocus="this.select();" onkeypress="return SetPolineFlag();" onkeyup="javascript:this.value=Comma(this.value);" CssClass="form-control" Text='<%#Eval("UnitPrice") %>' OnTextChanged="txtPOUnitPrice_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Total Price" ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtPOUnitTotal" runat="server" onfocus="this.select();" onkeypress="return SetPolineFlag();" onkeyup="javascript:this.value=Comma(this.value);" CssClass="form-control" Text='<%#Eval("TotalPrice") %>' OnTextChanged="txtPOUnitTotal_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <asp:GridView ID="grd" AutoGenerateSelectButton="false" SelectedRowStyle-Font-Bold="true" SelectedRowStyle-BackColor="Silver" DataKeyNames="POLINEID" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" OnRowCreated="grd_RowCreated" OnRowUpdating="grd_RowUpdating" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="grd_RowEditing" OnRowCommand="grd_RowCommand">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="" ItemStyle-Width="9%">
                                        <HeaderTemplate>
                                            <asp:CheckBox ID="chkCC" runat="server" Text="&nbspCost Code" />
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtPOCostCode1" runat="server" CssClass="form-control" onkeypress="return SetPolineFlag();" Text='<%#Eval("CostCode") %>' onfocus="this.select();"></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtPOCostCodeNew" runat="server" CssClass="form-control" Text='<%#Eval("CostCode") %>' onfocus="this.select();"></asp:TextBox>
                                        </FooterTemplate>
                                        <ItemStyle Width="9%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Line Type" ItemStyle-Width="8%">
                                        <HeaderTemplate>
                                            <asp:CheckBox ID="chkLT" runat="server" Text="&nbspLine Type" />
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblPLT" runat="server" Text='<%# Eval("POType") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:DropDownList ID="ddlLineType1" runat="server" CssClass="form-control" onkeypress="return SetPolineFlag();" DataSourceID="DSgvPurchaseType" DataValueField="Value" DataTextField="Description"></asp:DropDownList>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:DropDownList ID="ddlLineTypeNew" runat="server" CssClass="form-control" onkeypress="return SetPolineFlag();" DataSourceID="DSgvPurchaseType" DataValueField="Value" DataTextField="Description" OnTextChanged="ddlLineType_TextChanged" AutoPostBack="true"></asp:DropDownList>
                                        </FooterTemplate>
                                        <ItemStyle Width="8%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Supplier Ref" ItemStyle-Width="9%">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtgvCATALOGCODE1" runat="server" CssClass="form-control" onkeypress="return SetPolineFlag();" onfocus="this.select();" Text='<%#Eval("CATALOGCODE") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtgvCATALOGCODENew" runat="server" CssClass="form-control" onkeypress="return SetPolineFlag();" onfocus="this.select();" Text='<%#Eval("CATALOGCODE") %>'></asp:TextBox>
                                        </FooterTemplate>
                                        <ItemStyle Width="9%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Description" ItemStyle-Width="30%">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtgvDescription1" runat="server" CssClass="form-control" MaxLength="500" Rows="15" Height="50px" TextMode="MultiLine" Text='<%#Eval("Description") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtgvDescriptionNew" runat="server" CssClass="form-control" MaxLength="500" Rows="15" Height="50px" TextMode="MultiLine" Text='<%#Eval("Description") %>'></asp:TextBox>
                                        </FooterTemplate>
                                        <ItemStyle Width="30%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Quantity" ItemStyle-Width="7%">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtPOQtn1" runat="server" CssClass="form-control" onfocus="this.select();" Text='<%#Eval("Quantity") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtPOQtnNew" runat="server" CssClass="form-control" onfocus="this.select();" Text='<%#Eval("Quantity") %>'></asp:TextBox>
                                        </FooterTemplate>
                                        <ItemStyle Width="7%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="UOM" ItemStyle-Width="8%">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtPOUnit1" runat="server" CssClass="form-control" Text='<%#Eval("Unit") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtPOUnitNew" runat="server" CssClass="form-control" Text='<%#Eval("Unit") %>'></asp:TextBox>
                                        </FooterTemplate>
                                        <ItemStyle Width="8%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Unit Price" ItemStyle-Width="8%">
                                        <HeaderTemplate>
                                            <asp:CheckBox ID="chkUP" runat="server" Text="Unit Price" />
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtPOUnitPrice1" runat="server" CssClass="form-control" Text='<%#Eval("UnitPrice") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtPOUnitPriceNew" runat="server" CssClass="form-control" Text='<%#Eval("UnitPrice") %>'></asp:TextBox>
                                        </FooterTemplate>
                                        <ItemStyle Width="8%" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="" ShowHeader="false">
                                        <ItemTemplate>
                                            <%--                                            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/file_edit.png" Width="15px" Height="15px" CommandName="Edit" ToolTip="Edit Record" />
                                        ...
                                        <FooterTemplate>
                                            ...
                                            <asp:LinkButton ID="btncancel" runat="server" CommandName="CancelF" Text="Cancel"></asp:LinkButton>--%>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                                        Cost Code:</label>
                                                    <div class="col-sm-7">
                                                        <asp:TextBox ID="txtDCostCode" runat="server" CssClass="form-control" ValidationGroup="Equip"></asp:TextBox>
                                                    </div>
                                                    <div style="width: 2%; float: left;">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                                        Item:</label>
                                                    <div class="col-sm-7">
                                                        <asp:TextBox ID="txtDItem" runat="server" CssClass="form-control" ValidationGroup="Equip"></asp:TextBox>
                                                    </div>
                                                    <div style="width: 2%; float: left;">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                                        Quantity</label>
                                                    <div class="col-sm-7">
                                                        <asp:TextBox ID="txtDQty" runat="server" CssClass="form-control" Text="0" ValidationGroup="Equip"></asp:TextBox>
                                                    </div>
                                                    <div style="width: 2%; float: left;">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                                        Line Type:</label>
                                                    <div class="col-sm-7">
                                                        <asp:DropDownList ID="ddlDLineType" runat="server" CssClass="form-control" onkeypress="return SetPolineFlag();" DataSourceID="DSgvPurchaseType" DataValueField="Value" DataTextField="Description"></asp:DropDownList>
                                                    </div>
                                                    <div style="width: 2%; float: left;">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                                        UOM:</label>
                                                    <div class="col-sm-7">
                                                        <asp:TextBox ID="txtDUOM" runat="server" CssClass="form-control" ValidationGroup="Equip"></asp:TextBox>
                                                    </div>
                                                    <div style="width: 2%; float: left;">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                                        Unit Price:</label>
                                                    <div class="col-sm-7">
                                                        <asp:TextBox ID="txtDUP" runat="server" CssClass="form-control" ValidationGroup="Equip"></asp:TextBox>
                                                    </div>
                                                    <div style="width: 2%; float: left;">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                                        Supplier Ref.</label>
                                                    <div class="col-sm-7">
                                                        <asp:TextBox ID="txtDCatalogCode" runat="server" CssClass="form-control" ValidationGroup="Equip"></asp:TextBox>
                                                    </div>
                                                    <div style="width: 2%; float: left;">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <asp:TextBox ID="txtDTP" runat="server" CssClass="form-control" Text="0" Enabled="false" ValidationGroup="Equip"></asp:TextBox>
                                                    </div>
                                                    <div style="width: 2%; float: left;">
                                                    </div>
                                                </div>
