<%@ Page Title="" Language="C#" MasterPageFile="~/Mgment/mainMaster.Master" AutoEventWireup="true" CodeBehind="frmUpdatePurchaseOrderMms2.aspx.cs" Inherits="FibrexSupplierPortal.Mgment.frmUpdatePurchaseOrderMms2" EnableEventValidation="false" ValidateRequest="false" %>
                ...
                <div class="tab-pane fade in" id="POLine">
                    <asp:UpdatePanel ID="upPOLInes" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="gvPoLInes" runat="server" AutoGenerateSelectButton="false" ShowFooter="false" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" OnRowDataBound="gvPoLInes_RowDataBound1" DataKeyNames="">
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <table>
                                                <tr>
                                                    <td><a id="displayText" href="javascript:toggle();">+ Show</a></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <div id="toggleText" style="display: none">
                                                            <asp:GridView ID="gvPolIneDetail" runat="server" AutoGenerateColumns="false" CssClass="ChildGrid">
                                                                <Columns>
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                            <div class="reg-panel panel panel-default">
                                    ...
                                    <asp:TemplateField HeaderText="Cost Code" ItemStyle-Width="9%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPOCostCode" runat="server" CssClass="form-control" Text='<%#Eval("COSTCODE") %>'></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Line Type" ItemStyle-Width="8%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPOCostCode" runat="server" CssClass="form-control" Text='<%#Eval("CATALOGCODE") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Line Type" ItemStyle-Width="8%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPOLineType" runat="server" CssClass="form-control" Text='<%#Eval("LINETYPE") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Supplier Ref" ItemStyle-Width="9%">
                                        <ItemTemplate>
                                            <asp:Label ID="txtgvCATALOGCODE" runat="server" CssClass="form-control" Text='<%#Eval("CATALOGCODE") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Description" ItemStyle-Width="33%">
                                        <ItemTemplate>
                                            <asp:Label ID="txtgvDescription" runat="server" CssClass="form-control" MaxLength="500" Rows="15" Height="50px" TextMode="MultiLine" Text='<%#Eval("ITEMDESCRIPTION") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Quantity" ItemStyle-Width="7%">
                                        <ItemTemplate>
                                            <asp:Label ID="txtPOQtn" runat="server" CssClass="form-control" Text='<%#Eval("ORDERQTY") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="UOM" ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:Label ID="txtPOUnit" runat="server" CssClass="form-control" Text='<%#Eval("ORDERUNIT") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Unit Price" ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:Label ID="txtPOUnitPrice" runat="server" CssClass="form-control" Text='<%#Eval("UNITCOST") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Total Price" ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:Label ID="txtPOUnitTotal" runat="server" CssClass="form-control" Text='<%#Eval("LINECOST") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="actions" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPurchaseActionTaken" runat="server" Text='<%#Eval("Actions") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>

                            <iframe id="iframePoLineLoad" src="frmPOLines.aspx" style="border: 0; width: 100%; min-height: 450px; max-height: 700px; display: none;"></iframe>
