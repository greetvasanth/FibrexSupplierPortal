                            ...
                            <asp:GridView ID="grd" AutoGenerateSelectButton="false" SelectedRowStyle-Font-Bold="true" SelectedRowStyle-BackColor="Silver" DataKeyNames="POLINEID" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" OnRowCreated="grd_RowCreated" OnRowUpdating="grd_RowUpdating" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="grd_RowEditing" OnRowCommand="grd_RowCommand">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="" ItemStyle-Width="9%">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtPOCostCodeEdit" runat="server" CssClass="form-control" onkeyup="return SetCCValue(this.value, 'txtDCostCode');" Text='<%#Eval("CostCode") %>' onfocus="this.select();" AutoPostBack="true" OnTextChanged="txtPOCostCode_TextChanged"></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtPOCostCodeNew" runat="server" CssClass="form-control" Text='<%#Eval("CostCode") %>' onfocus="this.select();" AutoPostBack="true" OnTextChanged="txtPOCostCode_TextChanged"></asp:TextBox>
                                        </FooterTemplate>
                                        <ItemStyle Width="9%" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Supplier Ref" ItemStyle-Width="9%">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtgvCATALOGCODEEdit" runat="server" CssClass="form-control" onkeyup="return SetCCValue(this.value, 'txtDCatalogCode');" onfocus="this.select();" Text='<%#Eval("CATALOGCODE") %>' OnTextChanged="txtgvCATALOGCODE_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtgvCATALOGCODENew" runat="server" CssClass="form-control" onkeyup="return SetPolineFlag();" onfocus="this.select();" Text='<%#Eval("CATALOGCODE") %>' OnTextChanged="txtgvCATALOGCODE_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </FooterTemplate>
                                        <ItemStyle Width="9%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Description" ItemStyle-Width="40%">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtgvDescriptionEdit" runat="server" CssClass="form-control" onkeyup="return SetCCValue(this.value, 'txtDItem');" MaxLength="500" Rows="15" Height="50px" TextMode="MultiLine" Text='<%#Eval("Description") %>' OnTextChanged="txtPoLinesDescription_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtgvDescriptionNew" runat="server" CssClass="form-control" MaxLength="500" Rows="15" Height="50px" TextMode="MultiLine" Text='<%#Eval("Description") %>' OnTextChanged="txtPoLinesDescription_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </FooterTemplate>
                                        <ItemStyle Width="30%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Quantity" ItemStyle-Width="8%">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtPOQtnEdit" runat="server" ClientIDMode="static" CssClass="form-control" onkeyup="return SetCCValue(this.value, 'txtDQty');" Text='<%#Eval("Quantity") %>' class="MaskText" OnTextChanged="txtPOQtn_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtPOQtnNew" runat="server" ClientIDMode="static" CssClass="form-control" onfocus="this.select();" Text='<%#Eval("Quantity") %>' class="MaskText" OnTextChanged="txtPOQtn_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </FooterTemplate>
                                        <ItemStyle Width="7%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="UOM" ItemStyle-Width="8%">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtPOUnitEdit" runat="server" CssClass="form-control" Text='<%#Eval("Unit") %>' onkeyup="return SetCCValue(this.value, 'txtDUOM');" OnTextChanged="txtPOUnit_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtPOUnitNew" runat="server" CssClass="form-control" Text='<%#Eval("Unit") %>' OnTextChanged="txtPOUnit_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </FooterTemplate>
                                        <ItemStyle Width="8%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Unit Price" ItemStyle-Width="10%">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtPOUnitPriceEdit" ClientIDMode="static" runat="server" CssClass="form-control" onkeyup="return SetCCValue(this.value, 'txtDUP');" Text='<%#Eval("UnitPrice") %>' class="MaskText" OnTextChanged="txtPOUnitPrice_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtPOUnitPriceNew" ClientIDMode="static" runat="server" CssClass="form-control" Text='<%#Eval("UnitPrice") %>' class="MaskText"></asp:TextBox>
                                        </FooterTemplate>
                                        <ItemStyle Width="8%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Total Price" ItemStyle-Width="8%">
                                        ...
                                        <EditItemTemplate>
                                            <asp:Label ID="lblTotalPriceEdit" runat="server" Text='<%# Eval("TotalPrice") %>'></asp:Label>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="actions" Visible="false">
                                        <ItemTemplate>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                                        Supplier Ref.</label>
                                                    <div class="col-sm-7">
                                                        <asp:TextBox ID="txtDCatalogCode" runat="server" CssClass="form-control" ValidationGroup="Equip" onkeyup="return SetDCCValue(this.value,'txtgvCATALOGCODEEdit');"></asp:TextBox>
                                                    </div>
                                                    <div style="width: 2%; float: left;">
                                                    </div>
                                                </div>
