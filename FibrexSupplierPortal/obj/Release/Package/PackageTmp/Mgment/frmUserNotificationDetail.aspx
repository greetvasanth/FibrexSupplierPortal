<%@ Page Title="" Language="C#" MasterPageFile="~/Mgment/Blankmaster.Master" AutoEventWireup="true" CodeBehind="frmUserNotificationDetail.aspx.cs" Inherits="FibrexSupplierPortal.Mgment.frmUserNotificationDetail"  Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="RPTheadingName">
        ...
        <div class="row" style="float: right; /*width: 16%; */ margin-top: -2px;">
            <asp:HyperLink ID="lnkAddnewEqupipment" runat="server" Text=" Back " CssClass="btn btn-primary" Target="_self"> </asp:HyperLink>
        </div>
    </div>
    <div class="row">
