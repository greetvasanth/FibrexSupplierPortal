<%@ Page Title="" Language="C#" MasterPageFile="~/Mgment/mainMaster.Master" AutoEventWireup="true" CodeBehind="frmFilterSpendByTopSupplier.aspx.cs" Inherits="FibrexSupplierPortal.Mgment.frmFilterSpendByTopSupplier" %>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <div class="col-sm-2 col-sm-offset-9" style="text-align: right;">
                                    &nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="btnSearchTemplates" runat="server" CssClass="btn btn-primary" IsDefault="true" Text="Run Report" OnClick="btnSearchTemplates_Click" />
