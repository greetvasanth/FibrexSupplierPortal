...
$(document).ready(function () {
    ...
    //$//('#ContentPlaceHolder1_txtCompanyName').change(function () {
        ...
        $(document).on('change', '#ContentPlaceHolder1_txtPOLinePurchaseOrderDescription', function (e) {
            if (this.value != '') {
                isDirtystcmp = true;
            }
            else {
    ...
    //
        $(document).on('change', '#ContentPlaceHolder1_txtExternalNotes', function (e) {
            if (this.value != '') {
                isDirtystcmp = true;
            }
            else {
        ...
        $(document).on('change', '#ContentPlaceHolder1_txtInternalNotes', function (e) {
            if (this.value != '') {
                isDirtystcmp = true;
            }
            else {
        ...
        $(document).on('change', '#ContentPlaceHolder1_txtSignaturePurchaseOrderDescription', function (e) {
            if (this.value != '') {
                isDirtystcmp = true;
            }
            else {
        ...
        $(document).on('change', '#ContentPlaceHolder1_txtAttachmentPurchaseOrderDescription', function (e) {
            if (this.value != '') {
                isDirtystcmp = true;
            }
            else {
        ...
        $(document).on('change', '#ContentPlaceHolder1_txtPOCurrency', function (e) {
            if (this.value != '') {
                isDirtystcmp = true;
            }
            else {
        ...
        $(document).on('change', '#ContentPlaceHolder1_txtRequistionRefNum', function (e) {
            if (this.value != '') {
        ...
        $(document).on('change', '#ContentPlaceHolder1_txtContractRef', function (e) {
            if (this.value != '') {
    ...
    //
        $(document).on('change', '#ContentPlaceHolder1_txtOriginalPO', function (e) {
            if (this.value != '') {
    ...
    //
        ...
        $(document).on('change', '#ContentPlaceHolder1_txtContactPerson2Email', function (e) {
            if (this.value != '') {
                IsDirtyContact2PersonEmail = true;
            }
            else {
                IsDirtyContact2PersonEmail = false;
            }
        });
    ...
    //txtPopupFileDescription
        $(document).on('change', '#ContentPlaceHolder1_txtEditSignatureHeading', function (e) {
            if (this.value != '') {
                IsDirtyAdditionalAmount = true;
            }
            else {
    ...
    //
        ...
        $(document).on('change', '#ContentPlaceHolder1_ddlEditLoadDesignation', function (e) {
            if (this.value != '') {
                IsDirtyAdditionalAmount = true;
            }
            else {
    ...
    //
        $(document).on('change', '#ContentPlaceHolder1_ddlEditSignatureUser', function (e) {
            if (this.value != '') {
                IsDirtyAdditionalDescription = true;
            }
            else {
