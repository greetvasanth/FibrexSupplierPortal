<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PurchaseOrderStatusHistory.ascx.cs" Inherits="FibrexSupplierPortal.Mgment.Control.PurchaseOrderStatusHistory" %>
...
<script>
    $(document).ready(function () {
        $('#ContentPlaceHolder1_PurchaseOrderStatusHistory_gvAllChangeStatusHistory').dataTable({
            "ordering": false
        });
    });
</script>
...
<div class="form-horizontal">
    <div class="table-responsive">
        <asp:GridView ID="gvAllChangeStatusHistory" runat="server" CssClass="table table-striped table-bordered table-hover" EmptyDataText="No search results" AutoGenerateColumns="False" OnRowDataBound="gvAllChangeStatusHistory_RowDataBound" DataKeyNames="POSTATUSHISTORYID">
            <Columns>
