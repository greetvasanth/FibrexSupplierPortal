<%@ Page Title="" Language="C#" MasterPageFile="~/Mgment/mainMaster.Master" AutoEventWireup="true" CodeBehind="frmNewTemplates.aspx.cs" Inherits="FibrexSupplierPortal.Mgment.frmNewTemplates" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#<%=txtTemplateDescription.ClientID%>').maxlength({
                events: [], // Array of events to be triggered
                maxCharacters: 250
            });
        });
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="RPTheadingName">
            <asp:Label ID="lblGeneralSupplierName" runat="server" Text="New Purchase Order Template"></asp:Label>
                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        <div class="col-sm-5">
                            ...
                            <div class="col-sm-8">
                                <asp:TextBox ID="txtTemplateName" runat="server" MaxLength="100" CssClass="form-control" ValidationGroup="Equip"></asp:TextBox>
                            </div>
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                            Vendor ID</label>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtCompanyID" runat="server" OnTextChanged="txtCompanyID_TextChanged" AutoPostBack="true" ReadOnly="true" CssClass="form-control" ValidationGroup="Equip"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                            Vendor Name</label>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtCompanyName" runat="server" ReadOnly="true" CssClass="form-control" ValidationGroup="Equip"></asp:TextBox>
                                        </div>
                                        <div style="width: 2%; float: left;">
                                        </div>
                                    </div>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                    Payment Terms</label>
                                <div class="col-sm-7">
                                    <asp:TextBox ID="txtPaymentTerms" runat="server" CssClass="form-control" ValidationGroup="Equip"></asp:TextBox>
                                </div>
                                <div style="width: 2%; float: left;">
                                </div>
                            </div>
